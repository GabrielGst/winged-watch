...
const URL = process.env.NEXT_PUBLIC_VERCEL_URL // Environment variable check
  ? `https://${process.env.NEXT_PUBLIC_VERCEL_URL}/api` // Conditional assignment
  : "http://localhost:3000/api"; // Fallback to localhost
